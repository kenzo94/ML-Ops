...
from mlProject.entity.config_entry import DataIngestionConfig, DataTransformationConfig, DataValidationConfig, ModelEvaluationConfig, ModelTrainerConfig
...
class ModelEvaluationManager:
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        ...
        model_evaluation_config = ModelEvaluationConfig(
            ...
            target_column=schemas.name,
            mlflow_uri="https://dagshub.com/kenzo94/ML-Ops.mlflow" 
        )
